            ...
            <div className="relative w-full">
                ...
                <div className="w-full flex justify-between max-[750px]:block">
                    <section className="w-1/2 mt-10 max-[750px]:w-full">
                        ...
                        <div className="bg-white w-9/12 m-auto p-4 pt-6 rounded-md logbooks">
                    ...
                    <section className="w-1/2 mt-14 max-[750px]:w-full">
                            <div className="w-10/12 text-center flex justify-evenly max-[1145px]:w-11/12">
                                <div className="w-5/12 p-5 border-2 border-gray-600 rounded-md h-fit tracking-wide max-[1145px]:w-1/2">
                                    <div className="text-7xl font-semibold text-gray-400">10</div>
                                    <h3 className="text-2xl">Logbooks</h3>
                                </div>
                                <div className="w-5/12 p-5 border-2 border-gray-600 rounded-md h-fit tracking-wide max-[1145px]:w-1/2">
                                    <div className="text-7xl font-semibold text-gray-400">10</div>
                                    <h3 className="text-2xl">Ongoing</h3>
                                </div>
                            </div>
                            <div className="w-10/12 text-center flex justify-evenly mt-8 max-[1145px]:w-11/12">
                                <div className="w-5/12 p-5 border-2 border-gray-600 rounded-md h-fit tracking-wide max-[1145px]:w-1/2">
                                    <div className="text-7xl font-semibold text-gray-400">10</div>
                                ...
                                <div className="w-5/12 p-5 border-2 border-gray-600 rounded-md h-fit tracking-wide max-[1145px]:w-1/2">
                                    <div className="text-7xl font-semibold text-gray-400">10</div>
                                    <h3 className="text-2xl">Downloads</h3>
                                </div>
                            </div>
                            <button className="w-9/12 bg-violet-500 p-3 text-white rounded-md mt-10 font-semibold tracking-wider ml-6 block">Create New +</button>
                    </section>
                </div>
            </div>
        </div>
